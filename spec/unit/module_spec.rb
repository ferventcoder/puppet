...
describe Puppet::Module do
  ...
  it "should have metadata if it has a metadata file and its data is not empty" do
    ...
    Puppet::FileSystem.stubs(:read).with(@module.metadata_file).returns "{\"foo\" : \"bar\"}"
  ...
  it "should not have metadata if has a metadata file and its data is empty" do
    Puppet::FileSystem.expects(:exist?).with(@module.metadata_file).returns true
    Puppet::FileSystem.stubs(:read).with(@module.metadata_file).returns "This is some invalid json.\n"
  ...
  it "should tolerate failure to parse" do
    Puppet::FileSystem.expects(:exist?).with(@module.metadata_file).returns true
    Puppet::FileSystem.stubs(:read).with(@module.metadata_file).returns(my_fixture('trailing-comma.json'))
  ...
  def a_module_with_metadata(data)
    ...
    Puppet::FileSystem.stubs(:read).with("/my/file").returns text
    mod
  end
